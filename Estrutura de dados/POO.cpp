...
class Lista : public Estrutura{
	public:
	void inserir_no_inicio(int chave)
		{
			No *temp = new No();
			temp->chave = chave;
			temp->prox = inicio;
...
class Fila : public Estrutura {
	...
	int main()
	{
		...
		printf("Você quer utilizar qual estrutura: ");
		printf("\n1 Lista Ligada");
		printf("\n2 Pilha");
		printf("\n3 Fila");
		cin >> escolher;
	...
	if (escolher = 2){
		...
		printf("\n1 Para Inserir no fim");
		printf("\n2 Para Deletar no fim");
		printf("\n3 Para printar a pilha");
		printf("\n4 Para mostrar o tamanho da lista");
		printf("\n5 Para Sair");
		...
		do
		{
			...
			case 1:
				cout << "Digite seu elemento: ";
				cin >> v;
				pilha.inserir_no_fim(v);
				break;

			case 2:
				pilha.deletar_no_fim();
				break;
	...
	if (escolher = 3){
		...
		printf("\n1 Para Inserir no fim");
		printf("\n2 Para Deletar no inicio");
		printf("\n3 Para printar a fila");
		printf("\n4 Para mostrar o tamanho da lista");
		printf("\n5 Para Sair");
